...
import Page_HelpfulResources from "../ProgramsAndEvents_Content/Page_HelpfulResources";

//declaring a class
export default class HelpfulResources extends React.Component {
