            ...
            <div className="page">
                ...
                <div className="page-content">
                    <section className="section info-section b-white">
                        <h3>Overview</h3>
                        <p className="list-section b-white">
                        ...
                        <section className="list-section b-blue">
                            ...
                            <p>If you are interested in joining one of the Learning Commons or would like more information, please contact Laurie Necasek, laurie.necasek@cpcc.edu.</p>
                        </section>            
                    </section>
                </div>
            </div>
