            ...
            <div className="page">
                ...
                <div className="events-page-content">
                    <section className="afss info-section line">
                        ...
                        <a href='https://pd.cpcc.edu/CPCC/Programs/Standard/Control/elmLearner.wml?UPID=0608112309&Segment=CourseHomePage&Option=&ReloadSegmentID=Classes&ReloadOptionID=&CourseID=FD-INF-342&ClassID=32130' target='_blank' rel='noopener noreferrer' className='b-blue b-shadow link'>Register now!</a>
