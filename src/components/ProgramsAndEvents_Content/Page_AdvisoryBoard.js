                ...
                <div className="page-content">
                    <section className="section info-section b-white">
                        ...
                        <section className="list-section b-grey">
                            ...
                            <p className='coming-soon b-blue b-shadow'>Advisory Board Terms and Members</p>
                            <p> If you have further questions about the board or board expectations, contact Shantell Strickland-Davis, shantell.stricklanddavis@cpcc.edu.</p>
                        </section>            
                    </section>
                </div>
            </div>
