                ...
                <div className="facultyAdmin-page-content">
                    <section className="list-section b-white">
                        <section className="list-section b-white">
                            ...
                            <a className='coming-soon b-blue b-shadow'>Fall 2020 Instructions for Recording Curriculum Attendance</a>
                            <a className='coming-soon b-blue b-shadow'>Enrollment Verification Activity (EVA)</a>
                            
                            <h3 className="center">Additional Info</h3>
                            
                            <a className='coming-soon b-blue b-shadow'>Full Time Equivalent (FTE) Reporting</a>
                            <a className='coming-soon b-blue b-shadow'>Attendance Policy (3.09)</a>
                            <a className='coming-soon b-blue b-shadow'>Central Piedmont Attendance System</a>
                        </section>
                        ...
                        <section className="list-section b-white line"> 
                            ...
                            <a className='coming-soon b-blue b-shadow'>Grading Policy</a>
                            <a className='coming-soon b-blue b-shadow line'>CPCC Catalog</a>
                        </section>
                        <section className="list-section b-white line"> 
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                            ...
                            <a className='coming-soon b-blue b-shadow'>Policy 7.09</a>
                            <p className='center'>Download the Student Grade Appeal Form (PDF).</p>
                            <a className='coming-soon b-blue b-shadow line'>Grade Appeal Form</a>
                        </section>
                        <section className="list-section b-white line"> 
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                            ...
                            <a className='coming-soon b-blue b-shadow'>Instructions for How to Enter Grades</a>
                        </section>
                        <section className="list-section b-white line"> 
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                            <h4>Incomplete</h4>
                            ...
                            <a className='coming-soon b-blue b-shadow'>Incomplete Grade Form (PDF)</a>
                        </section>
                        <section className="list-section b-white"> 
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                            ...
                            <section className="important-note-section b-white">
                                ...
                                <a className='coming-soon b-blue b-shadow'>Development Plan Toolkit</a>
                            </section>
                            <section className="important-note-section b-white">
                                <p className='center'>More Helpful Information</p>
                                <a className='coming-soon b-blue b-shadow'>Getting Started 101</a>
