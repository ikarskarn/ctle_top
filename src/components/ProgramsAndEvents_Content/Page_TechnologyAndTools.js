                ...
                <div className="page-content">
                    <section className="section info-section b-white">
                        ...
                        <section className="list-section b-white line">
                            ...
                            <p className='coming-soon b-blue b-shadow'>Webex</p>
                        </section>
                        <section className="list-section b-white line">
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                            <h4>Panopto</h4>
                            <p>Panopto enables you to record and deliver lectures and presentations.</p>
                            <p className='coming-soon b-blue b-shadow'>Panopto</p>
                        </section>
                        <section className="list-section b-white line">
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                            ...
                            <p className='coming-soon b-blue b-shadow'>Google Sites</p>
                        </section>
                        <section className="list-section b-white line">
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                            ...
                            <p className='coming-soon b-blue b-shadow'>Central Piedmont Cloud</p>
                        </section>
                        <section className="list-section b-white line">
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                            <h4>Blackboard</h4>
                            <p>Blackboard is the college’s current Learning Management System used to deliver courses at Central Piedmont.</p>
                            <p className='coming-soon b-blue b-shadow'>Blackboard</p>
                        </section>
                        <section className="important-note-section b-orange line">
                            ...
                            <p className='coming-soon b-blue b-shadow'>Comparisons</p>    
                        </section>
                        ...
                        <section className="list-section b-white line">
                            ...
                            <p className='coming-soon b-blue b-shadow'>Web Conferencing</p>
                        </section>
                        <section className="list-section b-white line">
                            <FontAwesomeIcon icon={faUserCircle} className='icon'/>
                        ...
                        <section className="list-section b-white line">
                            ...
                            <p className='coming-soon b-blue b-shadow'>Getting a Chromebook</p>
                            <p className='coming-soon b-orange b-shadow'>Use Google Drive Files Offline</p>
                        </section>
                    </section>
                </div>
            </div>
